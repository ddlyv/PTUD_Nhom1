    ...
    <div class="section1">
        ...
        <form action="" method="post">
            ...
            <?php
                ...
                $totalsql=mysqli_query($p->connectdb(),"SELECT * FROM phieuxetnghiem where maHoSo=$hoSoId");
                ...
                if(!empty($_REQUEST['txtsearch']) && isset($_REQUEST['nut'])=='Tìm kiếm')
                {
                    $p->search("SELECT pxn.maPhieu, concat(bn.hoTenDem, ' ', bn.ten) as  hoTenBenhNhan, lxn.tenLoai as tenLoaiXetNghiem, pxn.ketQuaXetNghiem,
                                    ...
                                    where concat(bn.hoTenDem, ' ', bn.ten) like '%".$_REQUEST['txtsearch']."%' and pxn.maHoSo=$hoSoId
